      ...
      <div className="workspace-grid">
        ...
        <aside id="workspace-preview" className="preview-panel">
          ...
          <section id="workspace-output" className="create-section create-output-section preview-output-settings">
            ...
            {ref2vaTurbo8TrainingShifts && <p className="field-help"><strong>Ref2VA Turbo 8 training recipe active:</strong> 6 video / 3 audio shifts are applied automatically for this official 768p v1.0 LoRA. The adapter requirement overrides both native and custom shift fields.</p>}</section>
