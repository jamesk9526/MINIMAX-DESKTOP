...
const ltxPreviewGraph = buildLtx25Workflow({ mode: 'image', preset: 'quality', prompt: 'preview test', width: 1280, height: 736, duration: 5, seed: 42, previewOverride: { nodeType: 'LTX2SamplingPreviewOverride', fps: 8 }, filenamePrefix: 'ltx-preview-test' }, ltxModels, { name: 'first.png' })
...
assert.equal(ltxPreviewGraph['46'].inputs.preview_rate, 8)
